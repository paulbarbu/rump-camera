...
Based on this, I fiddled with the idea of creating surveillance software that runs on bare-metal hardware and
...
\begin{figure}
  \centering
  \fbox{\includegraphics{video-list}}
...
\item \texttt{\_httpd\_list\_files} together with \texttt{\_sprint\_video\_list} create and render
...
library and is manually coded in \texttt{video.c} and \texttt{video.h},
...
\begin{figure}
  \centering
  \fbox{\includegraphics[scale=0.75]{rumpcamera-arch}}
...
then be chained together in a system that resemble software pipe lines or functional composition.
...
This paper successfully demonstrates that surveillance software, with real requirements,
 ...
 Also when security is of concern, the unikernel approach to developing application can help since
 ...
 since this would mean too many re-compilations, also this applies for feature-full software,
